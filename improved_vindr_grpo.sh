#!/bin/bash
#SBATCH --job-name=vindr_clean_grpo
#SBATCH --account=a135
...
pip install --quiet scikit-learn  # For advanced text processing if needed

echo "🚀 Starting Clean VinDR GRPO Training..."
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen_map_reward_spacy_clean' \
...
echo "🎉 Clean VinDR GRPO Training Completed!"
echo "📊 Results:"
echo "   • Multi-box fuzzy mAP scoring: ✅ Preserved"
echo "   • spaCy medical label extraction: ✅ Added as bonus"
echo "   • Training log: job_outputs/vindr_clean_grpo_%j.txt"
echo "   • Error log: job_outputs/vindr_clean_grpo_%j.err"