...
# Run VERL PPO training with FAST settings (no filtering)
...
data.train_files=$WORK_DIR/data/train_verl_iou.parquet \
data.val_files=$WORK_DIR/data/val_verl_iou.parquet \
...
trainer.project_name=verl_iou_grounding_fast \
trainer.experiment_name=vindr_grounding_iou_fast \
