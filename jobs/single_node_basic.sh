#!/bin/bash
#SBATCH --job-name=verl_ppo_basic_iou
...
# Run VERL PPO training with basic_iou reward function
...
trainer.project_name=verl_iou_grounding_basic_iou \
trainer.experiment_name=vindr_grounding_basic_iou \
